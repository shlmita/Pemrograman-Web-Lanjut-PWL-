...
<head>
  ...
  <title>@yield('judul') - Kopi Kenangan Senja</title>

  <!-- favicon -->
  <link href="{{asset('/komponen/img/icon.png')}}" rel="icon">
  ...
  <!-- My Style -->
  <link rel="stylesheet" href="{{asset('/komponen/css/style.css')}}">
</head>
...
<body>
  ...
  <nav class="navbar">
    ...
    <div class="shopping-cart">
      <div class="cart-item">
        <img src="{{asset('/komponen/img/products/1.jpg')}}" alt="Product 1">
  ...
  <section id="about" class="about">
    ...
    <div class="row">
      <div class="about-img">
        <img src="{{asset('/komponen/img/tentang-kami.jpg')}}" alt="Tentang Kami">
      </div>
      <div class="content">
  ...
  <section id="menu" class="menu">
    ...
    <div class="row">
      <div class="menu-card">
        <img src="{{asset('/komponen/img/menu/1.jpg')}}" alt="Espresso" class="menu-card-img">
  ...
  <!-- My Javascript -->
  <script src="{{asset('/komponen/js/script.js')}}"></script>
</body>
